...
class SignalPolicy:
    ...
    minimum_bci_raw_samples: int = 1024
...
class WorkflowRules:
    ...
    def training_ready(self, session: "TrainingSession", labels) -> bool:
        ...
        try:
            ...
            # collection and bypassing the Version 1 persistence contract.
    ...
    def feature_snapshot_usable(self, snapshot: "EEGSnapshot") -> bool:
        ...
        return (
            ...
            and snapshot.raw_buffered_samples >= self.policy.minimum_bci_raw_samples
            and self.policy.minimum_raw_rate_hz <= snapshot.raw_rate_hz <= self.policy.maximum_raw_rate_hz
            and snapshot.raw_spread >= self.policy.minimum_raw_spread
        )
