...
class CognitiveEstimator:
    ...
    def _compute(self, stamp: float) -> bool:
        ...
        powers = {
            "delta": self._band_power(freqs, power, 0.5, 4.0),
            "theta": self._band_power(freqs, power, 4.0, 8.0),
            "low_alpha": self._band_power(freqs, power, 8.0, 10.0),
            "high_alpha": self._band_power(freqs, power, 10.0, 13.0),
            "low_beta": self._band_power(freqs, power, 13.0, 20.0),
            "high_beta": self._band_power(freqs, power, 20.0, 30.0),
            "low_gamma": self._band_power(freqs, power, 30.0, 40.0),
            "mid_gamma": self._band_power(freqs, power, 40.0, 50.0),
        }
        ...
        # Keep the relative magnitude of the FFT powers.  The BCI is calibrated
